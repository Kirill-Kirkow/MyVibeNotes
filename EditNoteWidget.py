...
class EditNoteWidget(QWidget):
    def __init__(self):
        ...
        uic.loadUi('Qt_widgets/EditNoteWidget.ui', self)  # Импорт ui файла
    ...
    def ChangeType(self, button_id):  # Метод для изменения типа заметки при нажатии на кнопку
        if button_id == 1 and self.type != 'Job_is_done':  # Если была нажата зелёная кнопка и тип заметки != Задача выполнена
            ...
            self.green_button.setIcon(QIcon('UI/lump_green_on.png'))  # Меняем внешний
            self.yellow_button.setIcon(QIcon('UI/lump_yellow_off.png'))  # вид кнопок
            self.red_button.setIcon(QIcon('UI/lump_red_off.png'))  # смены типа заметки
            ...
            self.green_button.setIcon(QIcon('UI/lump_green_off.png'))  # Меняем внешний
            self.yellow_button.setIcon(QIcon('UI/lump_yellow_on.png'))  # вид кнопок
            self.red_button.setIcon(QIcon('UI/lump_red_off.png'))  # смены типа заметки
            ...
            self.green_button.setIcon(QIcon('UI/lump_green_off.png'))  # Меняем внешний
            self.yellow_button.setIcon(QIcon('UI/lump_yellow_off.png'))  # вид кнопок
            self.red_button.setIcon(QIcon('UI/lump_red_on.png'))  # смены типа заметки
