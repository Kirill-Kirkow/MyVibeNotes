...
class RegisterWidget(QWidget):  # Класс окна регистрации
    def __init__(self):
        ...
        uic.loadUi('Qt_widgets/RegisterWidget.ui', self)  # Импорт ui файла
        ...
        self.main_window.exit_button.clicked.connect(lambda: self.ExitMainWindow())  # Назначение дйствий при нажатии на кнопку выхода из аккаунта (находится на главном окне программы)
